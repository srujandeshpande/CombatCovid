...
$(function(){
  ...
  url: '/api/ema_admin_ema_data',
  type: 'POST',
  data: JSON.stringify({'ema_role':'mo', 'phc_phone_number':'websiteuserphc'}),
  contentType: 'application/json; charset=utf-8',
  dataType: 'json',
  async: true,
  success: function(msg) {
